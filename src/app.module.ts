...
@Module({
  imports: [
    ...
    MongooseModule.forRoot(
      ...
      : `mongodb://${process.env.MONGODB_USERNAME}:${process.env.MONGODB_PASSWORD}@${process.env.MONGODB_HOST}:27017/?replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false`, {
        dbName: 'alardin'
      }
    ),
    MateModule, 
